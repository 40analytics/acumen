...
import { Check, Wallet, ArrowDownToLine, Receipt } from 'lucide-react';
...
export default function Billing() {
  ...
  const checkout = useMutation({
    ...
    onError: (err) => {
      alert(err instanceof ApiError ? err.message : 'Could not start payment');
  ...
  return (
    <AppShell>
      <div className="container-page py-10">
        ...
        <p className="text-center text-[12.5px] text-faint mb-12">
          All prices in USD shown. You'll be charged in {packsData?.currency ?? 'GHS'} via Paystack.
          Credits never expire.
        </p>
